...
### Who Wants to Live Forever might be the saddest song in the TOP2000 {data-commentary-width=400}
...
#### Self-Similarity Matrice Timbre
```{r}
WWTLF2 |>
...
***
Another interesting song by Queen in the TOP2000 is Who Wants to Live Forever. This song turned out to be an outlier in the scatter plot by having a low valence score and a low danceability score.

### Fix You by Coldplay {data-commentary-width=400}
