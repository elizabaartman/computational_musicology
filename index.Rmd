...
### Chromagrams: How pitch makes Bohemian Rhapsody number 1 {.storyboard}
```{r}
Bohemian <- 
...
Bohemian_chromagram <- Bohemian |>
  ...
  geom_tile() +
  labs(x = "Time (s)", y = NULL, fill = "Magnitude", title = "Bohemian Rhapsody (Queen)") +
  theme_minimal() +
...
Brel_chromagram <- Brel |>
  ...
  geom_tile() +
  labs(x = "Time (s)", y = NULL, fill = "Magnitude", title = "Ne Me Quitte Pas (Jacques Brel)") +
  theme_minimal() +
  scale_fill_viridis_c()
...
FixYou1_chromagram <- FixYou1 |>
  ...
  geom_tile() +
  labs(x = "Time (s)", y = NULL, fill = "Magnitude", title = "Fix You (Coldplay)") +
  theme_minimal() +
  scale_fill_viridis_c()
...
Ramses_chromagram <- Ramses |>
  ...
  geom_tile() +
  labs(x = "Time (s)", y = NULL, fill = "Magnitude", title = "Zing - Vecht - Huil - Bid - Lach - Werk En Bewonder (Ramses Shaffy)") +
  theme_minimal() +
  scale_fill_viridis_c()

plot_grid(Bohemian_chromagram, Brel_chromagram, FixYou1_chromagram, Ramses_chromagram, ncol = 2, nrow = 2)
```
...
Positions of [Bohemian Rhapsody](https://open.spotify.com/track/4u7EnebtmKWzUH433cf5Qv?si=3de371f1a98e43a4): 1999: no. 1, 2009: no. 1, 2019: no. 1, 2022: no. 1

Positions of [Ne Me Quitte Pas](https://open.spotify.com/track/6IRA4KOVbtiGiTdYoEThJN?si=767af0c0a0b14ce4): 1999: no. 66, 2009: no. 94, 2019: no. 415, 2022: no. 244

Positions of [Fix You](https://open.spotify.com/track/7LVHVU3tWfcxj5aiPFEW4Q?si=e5956007578143f6): 1999: -, 2009: no. 1494, 2019: no. 8, 2022: no. 5

Positions of [Zing - Vecht - Huil - Bid - Lach - Werk en Bewonder](https://open.spotify.com/track/4WCySsw36GzONhLAaBtn2g?si=e9f401df5af54e4e): 1999: no. 297, 2009: no. 7, 2019: no. 167, 2022: no. 319
...
Goldband_cepstrogram <- Goldband |>
  ...
  geom_tile() +
  labs(x = "Time (s)", y = NULL, fill = "Magnitude", title = "Noodgeval (Goldband)") +
  scale_fill_viridis_c() +                              
  theme_classic()
...
Summertime_cepstrogram <- Summertime |>
  ...
  geom_tile() +
  labs(x = "Time (s)", y = NULL, fill = "Magnitude", title = "Summertime (Billie Holiday)") +
  scale_fill_viridis_c() +                              
  theme_classic()
...
Nirvana_cepstrogram <- Nirvana |>
  ...
  geom_tile() +
  labs(x = "Time (s)", y = NULL, fill = "Magnitude", title = "Heart-Shaped Box (Nirvana)") +
  scale_fill_viridis_c() +                              
  theme_classic()
...
DoeMaar_cepstrogram <- DoeMaar |>
  ...
  geom_tile() +
  labs(x = "Time (s)", y = NULL, fill = "Magnitude", title = "Belle Hélène (Doe Maar)") +
  scale_fill_viridis_c() +                              
  theme_classic()
...
Positions of [Noodgeval](https://open.spotify.com/track/2LcmbuYX7tyR4DWy3b273L?si=43377d5030724a6e): 1999:-, 2009: -, 2019: -, 2022: no. 55

Positions of [Summertime](https://open.spotify.com/track/4DBZvNW9wB1vHzzRcFbDZF?si=d2910d8b561f45ca): 1999: no. 562, 2009: no. 1293, 2019: -, 2022: -

Positions of [Heart-Shaped Box](https://open.spotify.com/track/11LmqTE2naFULdEP94AUBa?si=0ae9e02314974195): 1999: -, 2009: -, 2019: no. 1019, 2022: no. 797

Positions of [Belle Hélène](https://open.spotify.com/track/46LNQvIkDX7hs0M466DD6h?si=d9e59785d8b841f5): 1999: -, 2009: no. 1165, 2019: no. 928, 2022: no. 516


### Self-similarity Matrices: Who Wants to Live Forever might be the saddest song in the TOP2000 {.storyboard}
```{r}
Queen <- 
...
Queen_selfsimilarity <- Queen |>
  ...
  theme_classic() +
  labs(x = "", y = "", title = "Pitch Who Wants To Live Forever (Queen)")
...
Queen1_selfsimilarity <- Queen1 |>
  ...
  scale_fill_viridis_c(guide = "none") +
  theme_classic() +
  labs(x = "", y = "", title = "Timbre Who Wants To Live Forever (Queen)")
...
ABBA_selfsimilarity <- ABBA |>
  ...
  scale_fill_viridis_c(guide = "none") +
  theme_classic() +
  labs(x = "", y = "", title = "Pitch Dancing Queen (ABBA)")
...
ABBA1_selfsimilarity <- ABBA1 |>
  ...
  scale_fill_viridis_c(guide = "none") +
  theme_classic() +
  labs(x = "", y = "", title = "Timbre Dancing Queen (ABBA)")

plot_grid(Queen_selfsimilarity, Queen1_selfsimilarity, ABBA_selfsimilarity, ABBA1_selfsimilarity, ncol = 2, nrow = 2)
```
...
Positions of [Who Wants To Live Forever](https://open.spotify.com/track/3SGP8It5WDnCONyApJKRTJ?si=dba1813eb9644cd7): 1999: no. 30, 2009: no. 77, 2019: no. 74, 2022: no. 101

Positions of [Dancing Queen](https://open.spotify.com/track/0GjEhVFGZW8afUYGChu3Rr?si=8e4e72e8444f442f): 1999: no. 16, 2009: no. 70, 2019: no. 68, 2022: no. 44

### Keygrams: Hey Jude {.storyboard}
...
Beatles_keygram <- Beatles |> 
  ...
  scale_fill_viridis_c(guide = "none") +
  theme_minimal() +
  labs(x = "Time (s)", y = "", title = "Penny Lane (The Beatles)")
...
Radiohead_keygram <- Radiohead |> 
  ...
  scale_fill_viridis_c(guide = "none") +
  theme_minimal() +
  labs(x = "Time (s)", y = "", title = "Paranoid Android (Radiohead)")
...
Genesis_keygram <- Genesis |> 
  ...
  scale_fill_viridis_c(guide = "none") +
  theme_minimal() +
  labs(x = "Time (s)", y = "", title = "Invisible Touch (Genesis)")
...
Backstreet_keygram <- Backstreet |> 
  ...
  scale_fill_viridis_c(guide = "none") +
  theme_minimal() +
  labs(x = "Time (s)", y = "", title = "I Want It That Way (Backstreet Boys)")
...
Positions of [Penny Lane](https://open.spotify.com/track/1sjmKmR4u9xDeJHjDCn2bZ?si=a4924e3ad4b0479b): 1999: no. 266, 2009: no. 324, 2019: no. 377, 2022: no. 563

Positions of [Paranoid Android](https://open.spotify.com/track/2nTsKOXIVGDf2iPeVQO2Gm?si=169004f8f51240bc): 1999: -, 2009: -, 2019: no. 342, 2022: no. 423

Positions of [Invisible Touch](https://open.spotify.com/track/7bkjJHsfX2rebJ3KZLegGt?si=1c48ae0e1db54a40): 1999: -, 2009: no. 1738, 2019: no. 1982, 2022: no. 130

Positions of [I Want It That Way](https://open.spotify.com/track/47BBI51FKFwOMlIiX6m8ya?si=341df457e9f94861): 1999: -, 2009: no. 1569, 2019: no. 1014, 2022: no. 910
...
Rainbow_tempogram <- Rainbow |>
  ...
  geom_raster() +
  scale_fill_viridis_c(guide = "none") +
  labs(x = "Time (s)", y = "Tempo (BPM)", title = "Rainbow In The Sky (Paul Elstak)") +
  theme_classic()
...
Killing_tempogram <- Killing |>
  ...
  geom_raster() +
  scale_fill_viridis_c(guide = "none") +
  labs(x = "Time (s)", y = "Tempo (BPM)", title = "Killing In The Name (Rage Against The Machine)") +
  theme_classic()
...
Adele_tempogram <- Adele |>
  ...
  geom_raster() +
  scale_fill_viridis_c(guide = "none") +
  labs(x = "Time (s)", y = "Tempo (BPM)", title = "Rumour Has It (Adele)") +
  theme_classic()

Rood <- get_tidy_audio_analysis("3yxFiZHkQgJmLEyhij30rr")
...
Rood_tempogram <- Rood |>
  ...
  geom_raster() +
  scale_fill_viridis_c(guide = "none") +
  labs(x = "Time (s)", y = "Tempo (BPM)", title = "Rood (Marco Borsato)") +
  theme_classic()

plot_grid(Rainbow_tempogram, Killing_tempogram, Adele_tempogram, Rood_tempogram, ncol = 2, nrow = 2)
```
...
Positions of [Rainbow in the Sky](https://open.spotify.com/track/2MlqP1HzhitHfFXPXKumdB?si=e2bdad09cfb343b4): 1999: -, 2009: -, 2019: no. 386, 2022: no. 366

Positions of [Killing In The Name](https://open.spotify.com/track/59WN2psjkt1tyaxjspN8fp?si=00be500cee6e4ae7): 1999: -, 2009: -, 2019: no. 60, 2022: no. 48

Positions of [Rumour Has It](https://open.spotify.com/track/5mFMb5OHI3cN0UjITVztCj?si=423627eababe4cd0): 1999: -, 2009: -, 2019: no. 1377, 2022: no. 1627

Positions of [Rood](https://open.spotify.com/track/3yxFiZHkQgJmLEyhij30rr?si=246eb44e6acf4c70): 1999: -, 2009: no. 79, 2019: no. 498, 2022: no. 1456
